<template>
  <section :id="anchorId ?? 'rsvp'" class="section rsvp-section" :class="[rootClass, sectionSizeClass]" :style="bg.style">
...
import type { PageSection, SectionDisplaySize, TenantConfig } from "../types/tenant";
...
const props = defineProps<{ tenant: TenantConfig; slug: string; anchorId?: string; background?: SectionBackgroundConfig; header?: PageSection["header"]; size?: SectionDisplaySize }>();
