<template>
  <section :id="anchorId ?? 'faq'" class="section faq-section" :class="[rootClass, sectionSizeClass]" :style="bg.style">
...
const props = defineProps<{ items: Array<{ question: string; answer: string }>; anchorId?: string; background?: SectionBackgroundConfig; size?: SectionDisplaySize }>();
